...
#Constants.
CON_LIS = []
with open("QAP4JTPY/const.dat") as file:
    for line in file:
...
while True:
   ...
   #User input.
    ...
    while True:
        ...
        elif set(CusCit).issubset(VAL_CHA) != True:
    ...
    while True:
        ...
        with open("QAP4JTPY/claimstorage.dat", "a+") as Storage:
            Iterations = 0
            for Ite in ClaLis: 
                Storage.write(Ite)
                Iterations += 1
    ...
    print(f" ----------------------------------------------------------------------")
    with open("QAP4JTPY/claimstorage.dat", "r") as Storage:
        for Line in Storage:
            PreCla = Line.split(" ")
