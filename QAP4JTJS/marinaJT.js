...
const MARINA_SITES = 100;
const EVEN_SITE_RATE = 80.00; 
const ODD_SITE_RATE = 120.00; 
const ALT_MEM_RATE = 5.00; 
 
const WEEK_CLEAN_RATE = 50.00; 
const VID_SURV_RATE = 35.00; 
 
const HST_RATE = 0.15; 
const STAN_MEM_DUES = 75.00; 
const EXEC_MEM_DUES = 150.00; 
 
const PROC_FEE = 59.99; 
const CANCEL_FEE = 0.60;

//Main program.
//Input.
let curDat = prompt("Enter The Current Date (YYYY-MM-DD): ");
let sitNum = parseInt(prompt("Enter Member's Site Number: "));
...
document.write("<tr>");
document.write("<td colspan='2'>" + memNam + "<br>" + strAdd + "<br>" + City + ", " + Prov + " " + posCod + "<br>");
